...
var options = {
  mode: pyMode,
  pythonPath: pyVersionPath,
  scriptPath: pyScriptPath,
  args: pyArgs,
  pythonOptions: ['-u']
};
var pyshell = new _pythonShell.PythonShell("script.py", options);

var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(expressServer) {
    var webSocketServer;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            webSocketServer = new _ws.WebSocket.Server({
              noServer: true,
              path: "/echo"
            });
            ...
            webSocketServer.on("connection", function connection(websocketConnection, connectionRequest) {
              ...
              connectionRequest.on("message", function (message) {
                var theMessage = message; //console.log(theMessage["bufferWindow"]);

                pyArgs[0] = theMessage;

                _pythonShell.PythonShell.run('script.py', options, function (err, results) {
                  if (err) throw err; //console.log(results);

                  connectionRequest.send(JSON.stringify(results)); //console.log("done  Sent");
                });
                /*
            ...
            return _context.abrupt("return", webSocketServer);
